...
class DefasagemRiskRecord(db.Model):  # type: ignore[name-defined]
    ...
    defasagem: Mapped[float] = mapped_column(Float, nullable=False)
    ...
    instituicao: Mapped[str] = mapped_column(String(16), nullable=False)
    pedra: Mapped[str] = mapped_column(String(16), nullable=False)
